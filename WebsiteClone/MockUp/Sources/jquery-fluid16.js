...
Toggle : function(){
	...
	$.each(
		["grid", "paragraphs", "blockquote", "list-items", "section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion-module","sponsors-module","myleft1","mymain","dashboard","operators","news","opportunity","datacheck"],
		function() {
